...
func NewListUsersQueryModel(typ string, relation string, object string, contextualTuples *[]relationshiptuple.RelationshipTupleWithConditionModel, context *map[string]interface{}) *ListUsersQueryModel {
